...
import { thesisRequestsRouter } from './routes/thesisRequests.js';
import { thesisPricingRouter } from './routes/thesisPricing.js';
...
app.use('/api/thesis-requests', thesisRequestsRouter);
app.use('/api/thesis-pricing', thesisPricingRouter);
